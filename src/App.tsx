          ...
          <ul className="flex flex-row gap-2">
            <li>
              <a aria-label="github" href="https://github.com/nanlabs" rel="noreferrer noopener" target="_blank">
                <span>
                  <svg width="2.3em" height="2.3em" viewBox="0 0 35 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <li>
              ...
              >
                <span>
                  <svg width="2.3em" height="2.3em" viewBox="0 0 35 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <li>
              <a aria-label="twitter" href="https://twitter.com/nanlabs" rel="noreferrer noopener" target="_blank">
                <span>
                  <svg
                    className="icon"
                    width="2.3em"
